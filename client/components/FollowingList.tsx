...
const users = [
  ...
  { pfp: 'https://upload.wikimedia.org/wikipedia/en/thumb/e/ea/Mike_Ehrmantraut_BCS_S3.png/220px-Mike_Ehrmantraut_BCS_S3.png', username: 'kid named finger' }
];

export const FollowingList: FC = () => {
  return (
    <div className='tw-w-[100%] dark:tw-bg-vapor-200 tw-rounded-[10px] tw-px-[4px] tw-pb-[10px] tw-sticky tw-top-[60px]'>
